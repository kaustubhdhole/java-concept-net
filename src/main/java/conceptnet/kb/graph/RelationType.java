...
public enum RelationType {
    ...
    LocatedNear("/r/LocatedNear", "A and B are typically found near each other. Symmetric.", "chair ↔ table"),
    ...
    SimilarTo("/r/SimilarTo", "A is similar to B. Symmetric.", "mixer ↔ food processor"),
    EtymologicallyRelatedTo("/r/EtymologicallyRelatedTo", "A and B have a common origin. Symmetric.", "folkmusiikki ↔ folk music"),
